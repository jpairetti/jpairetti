...
- **[Game Backlog API](https://github.com/jpairetti/game-backlog-api)** ⭐ — Flask REST API for tracking a video game wishlist, integrated with Wikidata, with token-based authentication and automated test coverage.
